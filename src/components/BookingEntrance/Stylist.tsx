      ...
      <div className="flex flex-wrap container mt-[120px] mb-[120px]">
        {
          [8, 8.5, 9, 9.5, 10, 10.5, 11, 11.5, 12, 12.5, 13, 13.5, 14, 14.5, 15, 15.5, 16, 16.5, 17, 17.5, 18, 18.5, 19, 19.5, 20, 20.5, 21].map(time => {
            if (Number.isInteger(time)) {
              return (
                <div className="p-2 w-1/2 md:w-1/4 h-[100px]" key={time} onClick={() => handleSelectTime(time)}>
                  <div className={`shadow-md rounded cursor-pointer text-center w-100 h-100 flex text-base font-semibold ${timeSelected === time ? "bg-[#9f6e0dd4] text-white" : ""}`}>
